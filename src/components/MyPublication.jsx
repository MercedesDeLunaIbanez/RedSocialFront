...
/**
 * Muestra las publicaciones del usuario autenticado con scroll infinito.
 *
 * @returns {JSX.Element} Contenedor con publicaciones del usuario.
 */
export default function MyPublication() {
  ...
  const {
     ...
     * @returns {{content: Array, pageIndex: number, totalPages: number}} Datos de la pagina.
     */
    ...
    /**
     * Indica a React Query que debe cargar la siguiente pagina si existe.
     *
     * @param {{ pageIndex: number, totalPages: number }} lastPage - Ultima pagina recibida.
     * @returns {number|undefined} Numero de pagina siguiente o undefined si no hay mas.
     */
  ...
  // Efecto de entrada de las tarjetas nuevas
  useEffect(() => {
